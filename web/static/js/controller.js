    ...
    robotshop.controller('productform', function($scope, $http, $routeParams, $timeout, currentUser) {
        ...
        $scope.addToCart = function() {
            ensureCartId().then((cartId) => {
                var url = '/api/cart/add/' + cartId + '/' + $scope.data.product.sku + '/' + $scope.data.quantity;
                ...
                console.log('ERROR', e);
                $scope.data.message = 'Unable to start cart session';
                $timeout(clearMessage, 3000);
            });
        };
    ...
    robotshop.controller('loginform', function($scope, $http, currentUser) {
        ...
        $scope.login = function() {
            ...
            $http({
                ...
                transformRequest: serializeForm,
                data: {
